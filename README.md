...
## Future lessons
Read [LESSON-STANDARD.md](LESSON-STANDARD.md) and [AGENTS.md](AGENTS.md) first. These record the shared visual system, source fidelity, workbook structure, guidance controls, versioning and export requirements. BP-01 release 2.4 follows the final PDF supplied 17 September 2026.

## Learner work
The browser may retain a temporary draft; no answers are saved to an account or GitHub. Learners must use Export workbook PDF, select Save as PDF in the browser print dialog, and save the file to keep their work. The export includes the complete lesson, diagrams, guidance and completed answers for the selected business strand. Export each strand separately. Old v1 drafts remain separately recoverable as text where present.
